...
FClassRegistrationInfo Z_Registration_Info_UClass_AAppPlayerController;
UClass* AAppPlayerController::GetPrivateStaticClass()
{
	using TClass = AAppPlayerController;
	if (!Z_Registration_Info_UClass_AAppPlayerController.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("AppPlayerController"),
			Z_Registration_Info_UClass_AAppPlayerController.InnerSingleton,
			StaticRegisterNativesAAppPlayerController,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_AAppPlayerController.InnerSingleton;
}
UClass* Z_Construct_UClass_AAppPlayerController_NoRegister()
{
	return AAppPlayerController::GetPrivateStaticClass();
}
...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AAppPlayerController_Statics::NewProp_DefaultMappingContexts = { "DefaultMappingContexts", nullptr, (EPropertyFlags)0x0020080000000015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AAppPlayerController, DefaultMappingContexts), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DefaultMappingContexts_MetaData), NewProp_DefaultMappingContexts_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AAppPlayerController_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AAppPlayerController_Statics::NewProp_DefaultMappingContexts_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AAppPlayerController_Statics::NewProp_DefaultMappingContexts,
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_octav_Unreal_Projects_App_Source_App_AppPlayerController_h__Script_App_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AAppPlayerController, AAppPlayerController::StaticClass, TEXT("AAppPlayerController"), &Z_Registration_Info_UClass_AAppPlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AAppPlayerController), 412517299U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_octav_Unreal_Projects_App_Source_App_AppPlayerController_h__Script_App_1386405388(TEXT("/Script/App"),
	Z_CompiledInDeferFile_FID_Users_octav_Unreal_Projects_App_Source_App_AppPlayerController_h__Script_App_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_octav_Unreal_Projects_App_Source_App_AppPlayerController_h__Script_App_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
